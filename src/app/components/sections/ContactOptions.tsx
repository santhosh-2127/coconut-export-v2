...
const contactMethods = [
  {
    ...
    description: "Instant messaging for quick queries. Share product photos, documents, and get real-time responses.",
  ...
  },
  {
    ...
    description: "For detailed inquiries, technical specifications, and formal quotation requests. We respond within 24 hours.",
  ...
  },
  {
    ...
    description: "Speak directly with our export team during business hours for urgent sourcing requirements.",
  ...
  },
  {
    ...
    href: "#location",
    description: "Our operations are headquartered in the coconut heartlands of Southern India, close to major ports.",
  ...
  },
  {
    ...
    href: "#hours",
    description: "Our team accommodates time zone differences for international buyers across all major regions.",
