...
/* ─── Per-cert metadata: icon + descriptor ────────────────────────────── */
const certMeta: Record<string, { icon: React.ReactNode; descriptor: string }> = {
  "ISO 22000": {
    icon: (
      <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.4} className="w-5 h-5">
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-6 md:py-8">
        ...
        <motion.p
          ...
          className="text-center text-[10px] text-white/25 tracking-[0.12em] uppercase mt-4"
        >
