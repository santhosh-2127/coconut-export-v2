    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, ease: "easeOut" }} className="inline-flex items-center gap-3 mb-6">
          ...
          <span className="text-[#D4A017] text-[11px] font-semibold uppercase tracking-[0.24em]">Plan Your Shipment</span>
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.2, ease: "easeOut" }}
          ...
          Our export operations team is ready to support your shipping requirements — from container planning and documentation to freight coordination and delivery.
        </motion.p>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.35, ease: "easeOut" }}
          ...
          <a href="mailto:info@globalcocoexports.com?subject=Logistics%20Support"
