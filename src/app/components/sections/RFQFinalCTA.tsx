  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <a
            id="rfq-cta-request-quote"
            data-tracking-id="rfq-cta-request-quote"
            href="#rfq-form"
          ...
          <a
            id="rfq-cta-chat-whatsapp"
            data-tracking-id="rfq-cta-chat-whatsapp"
            href="https://wa.me/919876543210"
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => trackOutboundClick({ type: "whatsapp", label: "RFQ Page Chat On WhatsApp" })}
