      ...
      <div className="relative max-w-4xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <motion.a
            ...
            className="group relative bg-[#1B4332] text-white rounded-2xl p-6 overflow-hidden hover:bg-[#143A28] transition-all duration-300 active:scale-[0.98]"
          >
          ...
          <motion.a
            ...
            className="group relative bg-[#25D366] text-white rounded-2xl p-6 overflow-hidden hover:bg-[#20BD5A] transition-all duration-300 active:scale-[0.98]"
          >
          ...
          <motion.a
            ...
            className="group relative bg-[#FAFAFA] border border-[#E5E7EB] text-[#111827] rounded-2xl p-6 overflow-hidden hover:border-[#1B4332]/20 hover:shadow-md transition-all duration-300 active:scale-[0.98]"
          >
