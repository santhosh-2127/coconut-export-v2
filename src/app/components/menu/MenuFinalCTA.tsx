  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <a
            id="menu-cta-request-quote"
            data-tracking-id="menu-cta-request-quote"
            href="/#request-quote"
          ...
          <a
            id="menu-cta-chat-whatsapp"
            data-tracking-id="menu-cta-chat-whatsapp"
            href="https://wa.me/919876543210"
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => trackOutboundClick({ type: "whatsapp", label: "Menu Page Final CTA Chat On WhatsApp" })}
